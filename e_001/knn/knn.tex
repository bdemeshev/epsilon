...
## Relative absolute error                 15.6006 %
## Root relative squared error             51.5225 %
## Coverage of cases (0.95 level)          88.8    %
## Mean rel. region size (0.95 level)      10.57   %
...
##    2   8  79   1   0   1   2   4   1   1 |   c = 2
##    1   0   3  83   0   1   1   2   0   2 |   d = 3
##    0   2   0   0  90   0   2   2   0   9 |   e = 4
##    0   2   1   6   1  74   2   0   3   3 |   f = 5
##    1   3   0   0   0   0  89   0   1   0 |   g = 6
##    0   6   1   0   3   2   0  99   1   5 |   h = 7
##    0   3   4   4   0   4   1   0  70   1 |   i = 8
##    1   0   0   1  11   1   1   1   1  83 |   j = 9
\end{verbatim}
\end{kframe}
\end{knitrout}
